...
const FrontPage = () => {
    ...
    return (
        <div className="flex lex-row h-[85vh] bg-transparent w-[100vw] text-foreground ">
            ...
            <motion.div initial={{y: 50, opacity: 0}} animate={{y:0, opacity:100}} transition={{ duration: 0.3, delay:0.3 }} 
            className="flex-2 relative mr-[10vw] text-[3vw] mt-[15vh] w-[25vw] h-[25vw] min-w-[40vh] min-h-[40vh] border-background border-[1.5vw] bg-foreground rounded-full">
